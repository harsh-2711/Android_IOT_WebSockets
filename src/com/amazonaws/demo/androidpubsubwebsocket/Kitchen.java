...
public class Kitchen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        light = (Button) findViewById(R.id.kitchen_light_1);
    ...
    public void subscribe() {
        ...
        String topic = "$aws/things/esp_01_1001/shadow/update";
    ...
    public void publish() {
        ...
        String msg = "{\"state\": { \"desired\": { \"appl0_status\":\"" + String.valueOf(light_check) + "\" } } }";
